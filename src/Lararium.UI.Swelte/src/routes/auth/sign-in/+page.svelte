        ...
        <form class="login-form" id="loginForm">
            ...
            <div class="local-network-info">
                ...
                <div class="network-info-text">
                    Доступ разрешен только для устройств в вашей локальной сети.
                    Для настройки пользователей обратитесь к администратору
                    домашней сети.
                </div>
            </div>
        </form>
        ...
        <div class="right-content">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p class="feature-description">Общайтесь в домашней сети</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">Учет расходов и финансов</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">Планирование семейных дел</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">Контроль доступа в сети</p>
                </div>
            </div>
