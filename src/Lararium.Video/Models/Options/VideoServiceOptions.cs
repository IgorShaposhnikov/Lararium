namespace Lararium.Video.Models.Options
{
    ...
    public class VideoServiceOptions
    {
        ...
        /// <summary>
        /// Path to the temporary folder where uploaded videos are stored before processing or finalization.
        /// Useful for handling uploads safely before moving them to the final folder.
        /// </summary>
        public string UploadTempPath { get; init; } = string.Empty;

        /// <summary>
        /// Path to the final folder where videos are stored after upload or processing.
        /// This is the path that controllers or services should reference to access video files.
        /// </summary>
